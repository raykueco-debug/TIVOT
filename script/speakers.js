...
export const ART = {
  renna: { cm:169, eye:32, fx:0.519, top:1, bot:1521,
           base:'resources/partner/Renna_CI_front.webp', expr:{} },
  nouvelle: { cm:165, eye:40, fx:0.564, top:1, bot:1535,
           base:'resources/partner/Nouvelle_Priest_CI_front.webp', expr:{} },
  /* ⚠ 索拉娜用 **side** 那張：front 橫向佔 78%，兩人同台一定疊；側面只佔 69%。 */
  sorana: { cm:176, eye:27, fx:0.527, top:4, bot:1522,
           base:'resources/partner/Sorana_CI_side.webp', expr:{} },
  anya:   { cm:162, eye:34, fx:0.478, top:0, bot:1530,
           base:'resources/partner/Anya_CI_front.webp', expr:{} },
  ...
  luna:   { cm:160, eye:30, fx:0.500, top:0, bot:1000,
           base:'resources/partner/Luna_CI_exc.webp', expr:{}, unmeasured:true },
};
