    ...
    nodes: {
      ...
      gate:       { bg:'Tomb_Gate', name:'伊甸古墓　墓門',
        ...
        acts:[ { flag:'tomb_gate', fromStage:8, sides:{ RENNA:'L' }, lines:[
          ...
          nou('awkward','好像是……'),
          /* ⚠⚠ **ver -1521：改成 M1 路線限定**（Ray 的新稿：「M1路線派生」）——
             安雅敢說「交給我」是因為那一夜她被蕾娜跟上、身分說破了（`ep_m1_route`）。
             ⚠ A route（古墓）與 B route（東泊）是**非線性**的：先跑古墓的人
               根本還沒有那支旗 ⇒ 這一句不演，整段照樣讀得通。
             ⚠ 上面那兩句（「幽靈……要是有就好了。」與蕾娜的「連安雅小姐都……」）
               **不受這一條管** —— 稿上它們在分支之外。 */
          any('answer','幽靈……交給我。不要怕。', { onlyIf:'ep_m1_route' }),
