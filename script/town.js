    ...
    nodes: {
      ...
      inn: {
        ...
        /* 兩顆行動鈕在背景圖上的位置（**圖上的比例**，換算見 modules/town.js 的 bgPoint）。
           ⚠ ver -407 把睡覺那顆由 0.490 移到 0.620：兩顆要落在**對角**
             （坐坐＝左下的茶桌、睡覺＝右上的櫃台），不然會被讀成同一組選單（Ray 指定）。
             ⚠ 再往右就會與右側那排伙伴門撞在一起，不要超過 0.65。 */
        innSpots:{ sit:{ x:0.300, y:0.760 }, sleep:{ x:0.620, y:0.440 } },
        /* 初訪那一幕。⚠ 中間三拍是**演出**不是台詞：
             ① 畫面抖＋槍棺落地聲（無立繪）
