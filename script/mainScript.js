...
export const MAIN_SCRIPT = {
  ...
  /* ══ 帝都 攝政王廣場：正名蕾娜（Ray 的第三段正式稿，ver -359）══════════
     ⚠ 這一幕她**改叫蕾娜**（speaker `RENNA`）—— 上一幕是 `OFFICER`（顯示「監察官」），
       Ray 定案「當作兩個角色」。正名的那一句之後就一路用 RENNA。
     ⚠ 諾薇兒這一幕**還在用敬稱**，所以她那幾句仍然叫「監察官大人」——
       那是台詞內容，與 speaker id 無關。 */
  capital_square: {
    ...
    lines:[
      ...
      /* ⚠⚠ 稿上這一句標的是「蕾」，但內容是**諾薇兒**在附和（她口中的「監察官大人」
         ...
         `Renna_SI_awkwerd` 同樣是錯位）。**若原意真的是蕾娜，告訴我改回去。** */
  ...
  lake_deck: {
    ...
    lines:[
      ...
      { speaker:'SORANA_Q', text:'為什麼……你們不是來襲擊這個村子的嗎？',
        portrait:{ char:'SORANA_Q', expr:'guardtalk', show:true } },
      { speaker:'NOUVELLE', text:'襲擊？',
        portrait:{ char:'NOUVELLE', show:true } },
      { speaker:'SORANA_Q', text:'你們可找錯對手了，夏爾村可不是好欺負的！',
        portrait:{ expr:'guardtalk' } },
      { speaker:'RENNA', text:'妳才找錯對手了吧？我們怎麼看都是聖王廳的人啊！',
        portrait:{ char:'RENNA', expr:'upsetstare' } },
      { speaker:'SORANA_Q', text:'聖王廳？',
        portrait:{ char:'SORANA_Q', expr:'guard' } },
      { speaker:'SORANA_Q', text:'少騙人了！哪有駕著砲艇的修女跟全身武器的神父啊！',
        portrait:{ expr:'guardtalk' } },
      { speaker:'NOUVELLE', text:'真的啦，我們是聖約騎士團，',
        portrait:{ char:'NOUVELLE', expr:'surprise' } },
      { speaker:'NOUVELLE', text:'聖王廳直屬的執行機關喔。',
        portrait:{ expr:'awkward' } },
      { speaker:'SORANA_Q', text:'……',
        portrait:{ char:'SORANA_Q', expr:'guard' } },
      { speaker:'SORANA_Q', text:'那邊那個兇神惡煞的傢伙也是？',
        portrait:{ expr:'guardtalk' } },
      { speaker:'RENNA', text:'勉強，算是神父……',
        portrait:{ char:'RENNA', expr:'awkward' } },
      { speaker:'SORANA_Q', text:'……',
        portrait:{ char:'SORANA_Q', expr:'guard' } },
      { speaker:'SORANA_Q', text:'……',
      ...
      { speaker:'RENNA', text:'呃？',
        portrait:{ char:'RENNA', expr:'pause' } },
      { speaker:'ANYA', text:'？？？？',
      ...
      { speaker:'NOUVELLE', text:'請問——',
        portrait:{ expr:'talk' } },
      { speaker:'NOUVELLE', text:'村子裡有可以修這個的地方嗎？',
        portrait:{ expr:'awkward' } },
      /* 安雅捧著斷掉的舵（無台詞立繪拍：點擊才推進，§6.5）。 */
      { speaker:'ANYA', text:'',
        portrait:{ char:'ANYA', expr:'wheel', show:true } },
      { speaker:'SORANA', text:'喔？',
        portrait:{ char:'SORANA', expr:'talk' } },
      { speaker:'SORANA', text:'好誇張喔！怎麼弄的？',
        portrait:{ expr:'laugh' } },
      { speaker:'ANYA', text:'',
      ...
      { speaker:'SORANA', text:'村裡有個工匠，好像什麼都會修。',
        portrait:{ expr:'think' } },
      { speaker:'SORANA', text:'就是人挺怪的，去拜託他看看吧。',
        portrait:{ expr:'idea' } },
      { speaker:'RENNA', text:'那，能麻煩妳帶路嗎？',
        portrait:{ char:'RENNA', expr:'invite' } },
      { speaker:'SORANA', text:'沒問題。不過輪舵壞了，你來跟我手動操帆吧。',
        portrait:{ char:'SORANA', expr:'front' } },
      { speaker:'PLAYER', blank:true },
