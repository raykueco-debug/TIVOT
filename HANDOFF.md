# HANDOFF — 截至 `ver 2026.09.17-1543`
...
## ⚠⚠⚠ 伊甸古墓・追逐機制（ver -1574 規格盤點 —— **還沒實作**，兩件卡著）
...
|---|---|---|---|
| **6** | **5** | 2＋柱廳1＋2 ＝ **5 場** ⭐ | 6＋1＋5 ＝ **12 場** |
| 6 | 6 | 1＋1＋2 ＝ 4 場 | 5＋1＋4 ＝ 10 場 |
| 8 | 6 | 1＋1＋2 ＝ 4 場 | 4＋1＋4 ＝ 9 場 |
| 8 | 8 | 1＋1＋1 ＝ 3 場 | 3＋1＋3 ＝ 7 場 |

⭐ **建議：起始 6 格・擊退後停 5 回合** —— **直線衝也剛好 5 場**（＝他要的下限
   真的成立），逛完全圖 12 場。第一次被追上在第 5 步、之後每 4 步一次。
...
**還缺的一句**：上面那個敘事岔路（甲／乙／丙），
機制就能一次做完；雜兵的卡到齊之前，25% 那一條會是空的。
...
- ⚠ **等 Ray**：古墓 26 隻雜怪的**數值卡**（`_tomb_mon_spec.md`：「等 Ray，我不自己發明」）。
