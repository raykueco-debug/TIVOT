...
export const STRINGS = {
  ...
  loading: {
    ...
    hints: [
      ...
      '早すぎるカウンターは安全ですが、ほとんどダメージになりません。',
  ...
  result: {
    ...
    winSubBy:     { harm:'{name}を浄化', human:'{name}を撃破', ship:'{name}を撃沈',
                    target:'{name}を破壊', beast:'{name}を狩猟', aerial:'{name}を浄化',
                    slay:'{name}を討伐' },
    loseTitle:    '聖光消滅',
    loseSub:      'HUND、倒れる…',
    gradeCap:     '評価',
  ...
  tutorial: {
    steps: {
      ...
      threat: [
        { who:'partner',   text:'リングはどんどん小さくなる――早すぎても防げるけど、カウンターはほとんど効かないよ！' },
        { who:'partner',   text:'リングが十分に小さくなってから、正しいタイミングで押せば――カウンターがちゃんと刺さる！' },
    ...
    skipConfirm: {
      title: 'チュートリアルをスキップしますか？',
      sub:   'ホームの「チュートリアル」からいつでも見直せます',
      yes:   'スキップ',
      no:    '続ける',
    },
    result: {
      buttonLabel:    'つづける',   /* ver -358 起教學結算無監察官——其餘台詞欄位已清（ver -567） */
    },
  },
