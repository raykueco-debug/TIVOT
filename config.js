...
export const VERSION = 'ver 2026.09.17-1582';
...
export const GAME_CONFIG = {
  ...
  tuning: {
    ...
    /* ══⚠⚠⚠ **怪的等級 × 類型 × stage 加成**（ver -1582，Ray 定案）══════════════
       ...
       **基準是量出來的，不是拍的**：素身（不算女主升級／雙槍九星／副武器改裝／護符）
       ...
       隨 `critCombo` 走，而 `critCombo` **每盤歸零**）⇒ 一輪盤面的累計期望傷害：
           ...
           9,9,16,16,16 ：35 ／ 86 ／201 ／317 ／433   ← 預設序列
           16 格盤 ×5    ：75 ／188 ／304 ／420 ／535

       所以 `hp` 這一欄就是「**打幾盤會死**」：D＝2 盤、C＝3 盤、E＝賞金獵人原值、
       B＝整整一輪、A＝約 1.6 輪、S＝約 2.5 輪。
    ...
    enemyTier: {
      ...
      S: { hp:1100, atk:25, grids:[9,9,16,16,16], stack:1, desc:'強力boss' },
      A: { hp: 700, atk:20, grids:[9,9,16,16,16], stack:1, desc:'Boss' },
      B: { hp: 430, atk:16, grids:[9,9,16,16,16], stack:1, desc:'中boss' },
      C: { hp: 200, atk:12, grids:[9,9,16,9,16],  stack:0, desc:'略強小怪' },
