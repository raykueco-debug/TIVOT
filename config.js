...
export const VERSION = 'ver 2026.08.16-61';
...
export const GAME_CONFIG = {
  ...
  tutorial: {
    ...
    //   上修至 550 防強玩家提前擊殺（EXSECUTIŌ 會跳過最後一段教學）。
    //   ⚠ 真正的保證在機制端：教學段落未播完前（tutorialActive）敵血夾底 1 不可被殺
    //     （combat.enemyDamage 的教學夾傷），血量只影響收尾盤節奏。
    enemyHp: 550,
