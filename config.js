...
export const VERSION = 'ver 2026.08.16-59';
...
export const GAME_CONFIG = {
  ...
  tutorial: {
    ...
    //   由「終盤 overkill」條件反推：開場四回合累計傷害 ≈190（9+9 格普攻 ~85、
    //   雙槍盤 ~63、第四回合 8 格 ~40）＋聖徒化 16 格＋MB 追打 ≈260 → 約 450；
    //   取百位整數 500 → 收尾盤剩 ~50 血、約 8 格擊殺、餘格進 overkill 追打。
    enemyHp: 500,
