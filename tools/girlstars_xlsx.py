...
GLOSS = {
  ...
  'missGuard':        '點錯一次不算（盤面與評價都不算、連擊不斷）；點對就重置',
  'brReloadActive':   '發動彈雨傾洩回復主動技的使用次數',
  'saintReload':      '單場無傷擊殺回復聖徒化熔斷',
