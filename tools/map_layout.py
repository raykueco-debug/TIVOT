...
POS = {
  ...
  'tomb': {
    # ══ ver -1634 擴張：一層 +4 格、二層 +4 格（Ray：「更多的岔路與死路」）══
    #   ⚠ 方向就是相對位置（left＝欄變小、up＝列變小），畫完會自動驗一次。
    'scriptorium':(4,12),   # 誦經室再往裡（一層，死胡同）
    'confessio':(12,12),    # 禮拜堂的告解所（一層，死胡同）
    'sacristy':(10,10),     # 繞行廊的法衣室（一層，死胡同）
    'wellyard':(6,10),      # 迴廊的井庭（一層，死胡同）
    'colonnade':(2,7),      # 柱廳往西的列柱廊（二層，岔路）
    'mason':(2,6),          # 列柱廊盡頭的石工房（二層，死胡同）
    'waterstair':(4,5),     # 蓄水池再往裡（二層，死胡同）
    'censerroom':(8,8),     # 圓廳的香爐室（二層，死胡同）
    'lowaltar':(4,0),   # ver -1574：底層祭壇（骨坑後面）
    'bonepit':(4,1),
    'crypt':(6,1),
    'vaultW':(4,2),
    'gallery3':(6,2),
