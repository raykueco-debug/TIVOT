...
JOBS = [{
    ...
    # ⚠ 尺寸是**照成品的長寬比反推的**，不是猜的：unsquash 1.0 之後成品 733×1536
    #   ⇒ 高/寬 = 2.096。谷（折線 (938,712)→(950,882)）長 170 地圖格，
    #   要蓋滿再留一點邊 ⇒ 高 184 格（3689 世界單位）⇒ **planW 1760**（寬 88 格）。
    #   涵蓋 x 918~1006、y 705~889，谷的軸心（x 938~978、y 712~882）整段在框內。
    #   解析度 733/1760 = **0.42 texel/世界單位** —— 那是這張圖給得出的上限
    #   （1536px ÷ 170 格 ≈ 9px/格），不是參數調得出來的。
    'mx': 962, 'my': 797, 'planW': 1760, 'planRot': 0.0,
    'landmarks': [],
}]
